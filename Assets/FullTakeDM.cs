...
public class FullTakeDM : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("Death")) // ตรวจสอบว่าชนกับสิ่งที่เกิดความเสี่ยงหรือไม่
        {
            ...
            {
                healthSystem.TakeDamage(100f); // ปรับค่าความเสียหายตามที่ต้องการ
                Debug.Log("Noob");
            }
        }
    }
